...
def main():
    ...
    locobot.arm.set_ee_pose_components(x=0.46, y=0.0 ,z=0.35)
    # locobot.arm.set_ee_pose_components(x=0.46, y=-0.2 ,z=0.47)
    # locobot.arm.set_ee_pose_components(x=0.46, y=-0.2 ,z=0.1)
    # locobot.arm.set_ee_pose_components(x=0.46, y=0.2 ,z=0.1)
